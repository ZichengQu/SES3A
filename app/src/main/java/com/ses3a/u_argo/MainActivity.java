...
public class MainActivity extends AppCompatActivity implements MapboxMap.OnMapClickListener {
    ...
    private static Point ORIGIN_POINT = Point.fromLngLat(151.200726, -33.883726);
    private static Point DESTINATION_POINT = Point.fromLngLat(151.200726, -33.999999);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                ...
                mapboxMap.setStyle(new Style.Builder().fromUri(getString(R.string.styleUrl))
                        ...
                        .withImage(DESTINATION_ICON_ID, BitmapUtils.getBitmapFromDrawable(
                                getResources().getDrawable(R.drawable.ic_launcher_foreground))), new Style.OnStyleLoaded() {
                    @Override
